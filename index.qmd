...
$("#plus").click(function() {
  $("#teste").show("slow");
  $("#plus svg").replaceWith($("#minus svg"))
});
});
</script>
...
<div id='subtitle'>
<div id='subtitle-main'>Throughout history, Brazil's male football team has taken most of its players from Brazilian clubs.</div>
<div id='plus'>`r icons::feather_icons("plus-circle")` MORE INFO</div>
...
static <- field$plot +
    ...
    ### Places the teams names and amount of times their playeres were in the lineup
    geom_text_interactive(aes(x = x, y = y, label = Qtd, data_id = data_id),
